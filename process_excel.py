...
SCHEMA_VERSION = "gs5-static-shards-v1"
...
def classify_segment(raw: list[Any], other_label: str) -> str:
...
def process_raw_row(raw: list[Any], other_label: str) -> list[Any]:
    while len(raw) < 100:
        raw.append("")
    ...
    confidence = "Xanh"
    if any("Downtime thiếu" in item or "năm bất thường" in item for item in flags):
        confidence = "Đỏ"
    elif flags:
        confidence = "Vàng"
    ...
    obj: dict[str, Any] = {
        ...
        "segment": classify_segment(raw, other_label),
    ...
    try:
        with zipfile.ZipFile(workbook_path) as workbook:
            ...
            for row_number, raw in iter_sheet_rows(
                ...
                accepted += 1
                processed = process_raw_row(raw, other_label)
